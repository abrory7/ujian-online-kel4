<?php
  $db = new PDO('mysql:host=localhost; dbname=si_perpus', 'root', 'admin');
  $kueri = $db->prepare('select bookid, title, totalPage from book order by bookid ASC');
  $kueri->execute();
  $simpan = $kueri->fetchAll(PDO::FETCH_OBJ);
?>
<!DOCTYPE html>
<html>
  <head>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table class="table">
                    ...
                    <tbody>
                      <?php foreach($simpan as $tampil) { ?>
                      <tr>
                        <td><?php echo $tampil->bookid; ?></td>
                        <td><?php echo $tampil->title; ?></td>
                        <td><?php echo $tampil->totalPage; ?></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
